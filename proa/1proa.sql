...
CREATE TABLE usuarios (
    ...
    despacho VARCHAR(50),
    departamento_profesor ENUM('Informática', 'Matemáticas', 'Física' , 'Diseño'),
    carrera_alumno ENUM('Informática', 'Matemáticas', 'Física' , 'Diseño'),
...
-- Tabla archivos (para que los alumnos suban archivos de tareas)
