...
<aside class="sidebar">
    <nav class="menu-container">
        <button class="menu-btn activo" >
            <img src="../../../../imagenes/home.png" class="icono-menu icono-activo" />
            <span class="texto-activo">Inicio asignaturas</span>
        </button>
        <button class="menu-btn" onclick="window.location.href='tareasProfesor.html';">
                ...
                <ul class="asignaturas">
                    <li class="fila-objetivo">
                        <div class="encabezado-item">
                            ...
                            <button class="boton-revisar">Editar</button>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="encabezado-item">
                                ...
                                <div class="botonesEditaryVer">
                                    <button class="boton-revisar" onclick="window.location.href='EditarTarea.html'">Editar entrega</button>
                                    <button class="boton-revisar" onclick="window.location.href='VerEntregas.html'">Ver entregas</button>
                                </div>
                            </div>
                        </div>
                    </li>
