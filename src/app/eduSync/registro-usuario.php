...
$mail->Body = '
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background: #f9f9f9; border: 1px solid #ddd; border-radius: 10px;">
        ...
        <p style="font-size: 16px; color: #555;">
            Gracias por registrarte en <strong>GTI</strong>. Para completar tu registro, por favor haz clic en el botón de abajo:
        </p>
        <p style="text-align: center; margin: 30px 0;">
            <a href="' . $href . '" style="background-color: #28a745; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-size: 16px;">
                Confirmar Registro
            </a>
        </p>
